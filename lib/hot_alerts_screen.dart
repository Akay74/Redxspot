...
class HotAlertsScreen extends StatefulWidget {
  const HotAlertsScreen({super.key});

  @override
  State<HotAlertsScreen> createState() => _HotAlertsScreenState();
}

class _HotAlertsScreenState extends State<HotAlertsScreen> {
  ...
  Widget _buildHomeContent() {
    return SingleChildScrollView(
      child: Column(children: [
        ...
        SizedBox(
          child: Image.asset(
            'assets/images/hot_alerts_hero.png',
          ),
        ),
